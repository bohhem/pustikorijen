...
import RegionHierarchyPanel from '../../components/admin/RegionHierarchyPanel';
        ...
        <>
          ...
          <section className="grid gap-6 lg:grid-cols-[minmax(260px,340px)_1fr]">
            <RegionHierarchyPanel
              ...
              title={t('admin.manageRegions.hierarchyTitle')}
              subtitle={t('admin.manageRegions.hierarchyHint')}
            />
